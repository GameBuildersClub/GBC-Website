...
import hamburgers from "../../../styles/manifest.module.scss"
...
export default function Navigation () {
    ...
    return(
        ...
        <div className="flex flex-row justify-between mx-5 sm:mx-5 lg:mx-14 md:mx-12">
                ...
                (
                  ...
                  <button onClick={handleHamburgerClick} className={`${hamburgers["hamburger"]} ${hamburgers["hamburger--spin"]} ${isHamburgerClicked && hamburgers["is-active"]}`} type="button">
